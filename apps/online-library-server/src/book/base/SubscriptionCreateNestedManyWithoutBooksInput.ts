...
@InputType()
class SubscriptionCreateNestedManyWithoutBooksInput {
...
export { SubscriptionCreateNestedManyWithoutBooksInput as SubscriptionCreateNestedManyWithoutBooksInput };
